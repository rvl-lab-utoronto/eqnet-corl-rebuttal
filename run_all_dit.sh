...
python CleanDiffuser/pipelines/diffuser_d4rl_mujoco.py planner_net='transformer' mode='train' task='hopper-medium-expert-v2'
python CleanDiffuser/pipelines/diffuser_d4rl_mujoco.py planner_net='transformer' mode='train' task='hopper-medium-replay-v2'
python CleanDiffuser/pipelines/diffuser_d4rl_mujoco.py planner_net='eqntransformeret' mode='train' task='walker2d-medium-v2'
...
python CleanDiffuser/pipelines/diffuser_d4rl_mujoco.py planner_net='transformer' mode='train' task='halfcheetah-medium-v2'
...
python CleanDiffuser/pipelines/diffuser_d4rl_mujoco.py planner_net='transformer' mode='train' task='halfcheetah-medium-replay-v2'

# inference
python CleanDiffuser/pipelines/diffuser_d4rl_mujoco.py planner_net='transformer' mode='inference' task='hopper-medium-v2'
python CleanDiffuser/pipelines/diffuser_d4rl_mujoco.py planner_net='transformer' mode='inference' task='hopper-medium-expert-v2'
python CleanDiffuser/pipelines/diffuser_d4rl_mujoco.py planner_net='transformer' mode='inference' task='hopper-medium-replay-v2'
...
python CleanDiffuser/pipelines/diffuser_d4rl_mujoco.py planner_net='transformer' mode='inference' task='halfcheetah-medium-v2'
...
python CleanDiffuser/pipelines/diffuser_d4rl_mujoco.py planner_net='transformer' mode='inference' task='halfcheetah-medium-replay-v2'
